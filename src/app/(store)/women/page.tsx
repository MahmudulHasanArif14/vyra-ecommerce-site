...
export default async function WomenPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] min-h-screen text-white relative overflow-hidden">
      {/* Ambient glows — pink/purple for the women's collection */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-40 right-1/4 w-[500px] h-[500px] rounded-full bg-pink-500/10 blur-[130px]" />
        <div className="absolute top-1/3 -left-40 w-[600px] h-[600px] rounded-full bg-purple-500/10 blur-[150px]" />
      </div>
